        ...
        <div class="detailProductContent row">  
            ...
            <div class="col-xs-12 col-sm-7">
                ...
                <div class="detailProductContent__boxinfo">
                    ...
                    <hr>
                    <p class="priceNotSale">Gía cũ : <span>{{ $product->old_price }} đ</span></p>
                    <hr>
                    <p class="priceSale key">Gia ban : <span>{{ $product->price }} đ</span></p>
    ...
    <div class="container">
        <div class="bncTitle">
            <hgroup class="v2_bnc_title_main">
                <span class="v2_bnc_title_icon"><i class="fa fa-file"></i></span><h2>mo ta </h2>
            </hgroup>
        </div>
...
<section class="otherProduct">
    <div class="container">
        <div class="bncTitle">
            <hgroup class="v2_bnc_title_main">
                <span class="v2_bnc_title_icon"><i class="fa fa-file"></i></span><h2>Cac san pham lien quan</h2>
            </hgroup>
        </div>
...
<section class="commentFacebook">
    <div class="container">
        <div class="bncTitle">
            <hgroup class="v2_bnc_title_main">
                <span class="v2_bnc_title_icon"><i class="fa fa-file"></i></span><h2>Binh Luan Khach hang</h2>
            </hgroup>
        </div>
